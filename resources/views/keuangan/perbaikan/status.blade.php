  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <h5 class="m-0 "> Edit Status Perawatan </h5>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('keuangan-home') }}">Home</a></li>
              <li class="breadcrumb-item"><a href="{{ route('keuangan-perbaikan') }}">Perawatan</a></li>
        ...
        <div class="row">
          ...
          <div class="col-md-10">
            ...
            <div class="card card-dark">
              ...
              <!-- form start -->
              <div class="card-body">
                <form role="form" action="{{ route('keuangan-perbaikan-status') }}" method="POST" enctype="multipart/form-data">
                  {{csrf_field()}}

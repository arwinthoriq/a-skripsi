        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{ route('sarpras-jenis') }}">Ruang</a></li>
        ...
        <div class="row">
          ...
          <div class="col-md-10">
            ...
            <div class="card card-dark">
              ...
              <!-- form start -->
              <div class="card-body">
                <form role="form" action="{{ route('sarpras-ruang-form-edit') }}" method="POST" enctype="multipart/form-data">
                  {{csrf_field()}}
                              ...
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    <center><h6>Data Ruang Akan Berubah </h6> Apakah Anda Yakin ?</center>
                                  </div>
